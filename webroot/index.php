...
$app->theme->configure(ANAX_APP_PATH . 'config/theme_index.php');

// Set navbar
$app->navbar->configure(ANAX_APP_PATH . 'config/navbar_index.php');

$app->url->setUrlType(\Anax\Url\CUrl::URL_CLEAN);
$app->session;

$app->router->add('', function() use ($app) {
    $app->theme->setTitle("Games");
...
$app->router->add('users', function() use ($app) {
    ...
    $content = $app->fileContent->get('userPage.md');
    $content = $app->textFilter->doFilter($content, 'shortcode, markdown');
